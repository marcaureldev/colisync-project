...
type ContactErrors = Partial<Record<keyof Omit<ContactFormData, 'notifyRecipient' | 'additionalInstructions'>, string>>;


const Step3_Contact = forwardRef<Step3Ref, Step3ContactProps>(({ data, updateData }, ref) => {
  ...
  const validateForm = () => {
    ...
    } else if (!/^\+?\d{8,}$/.test(data.senderPhone.replace(/\s/g, ''))) { // Exemple de validation de format simple
        newErrors.senderPhone = "Format de téléphone invalide (minimum 8 chiffres, peut commencer par +).";
    }
    ...
    if (!data.recipientPhone.trim()) {
      newErrors.recipientPhone = "Le téléphone du destinataire est requis.";
        ...
        newErrors.recipientPhone = "Format de téléphone invalide (minimum 8 chiffres, peut commencer par +).";
    }
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Informations de Contact</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        {/* Informations de l'Expéditeur */}
        <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-md">
          <h3 className="text-md font-medium text-gray-700 dark:text-gray-300">Expéditeur</h3>
          <div>
            <Label htmlFor="senderName" className="text-sm">Nom complet</Label>
            <Input
              id="senderName"
              name="senderName"
          ...
          <div>
            <Label htmlFor="senderPhone" className="text-sm">Numéro de téléphone</Label>
            <Input
              id="senderPhone"
              name="senderPhone"
              type="tel"
        ...
        <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-md">
          <h3 className="text-md font-medium text-gray-700 dark:text-gray-300">Destinataire</h3>
          <div>
            <Label htmlFor="recipientName" className="text-sm">Nom complet</Label>
            <Input
              id="recipientName"
              name="recipientName"
          ...
          <div>
            <Label htmlFor="recipientPhone" className="text-sm">Numéro de téléphone</Label>
            <Input
              id="recipientPhone"
              name="recipientPhone"
              type="tel"
      ...
      <div>
        <Label htmlFor="additionalInstructions" className="text-sm">Instructions additionnelles (Optionnel)</Label>
        <Textarea
      ...
      <div className="flex items-center space-x-2 pt-2">
        ...
        />
        <Label htmlFor="notifyRecipient" className="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
...
Step3_Contact.displayName = 'Step3_Contact'; // Important pour forwardRef
